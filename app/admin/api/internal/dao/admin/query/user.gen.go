...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.CreatedAt = field.NewUint32(tableName, "created_at")
	_user.UpdatedAt = field.NewUint32(tableName, "updated_at")
	_user.DeletedAt = field.NewUint32(tableName, "deleted_at")
...
func (u *user) updateTableName(table string) *user {
	...
	u.CreatedAt = field.NewUint32(table, "created_at")
	u.UpdatedAt = field.NewUint32(table, "updated_at")
	u.DeletedAt = field.NewUint32(table, "deleted_at")
